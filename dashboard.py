...
with tab_about:
    ...
    <ul>
        <li>
            <b>الاعلانات المتضمنة لاكثر من صفحة:</b>
            قد يكون هناك بعص المشاريع لم يتم ادراجها وهي المشاريع التي لم تكن مدرجة في الصفحة الاولى اذا كان منشور الاعلان له اكثر من صفحة ولكن عددها قليل جدا وليس له تأثير كبير على النتائج
            سيتم العمل على اصلاح هذا النقص في الفترة القادمة.
        </li>
        <li>
...
# ─────────────────────────────────────────────────────────────
    ...
    st.caption(
       "تم تجميع بعض اسماء الشركات المتشابهة بشكل تلقائي لتفادي تأثير الاخطاء الاملائية على النتائج ولكن في بعض الاحيان قد تحدث اخطاء"
       "يمكنك مراجعة الاسماء التي تم دمجها وتصحيح الاخطاء ان وجدت"
    )
